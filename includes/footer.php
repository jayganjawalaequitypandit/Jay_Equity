    ...
    <div class="container">
        <div class="position-relative">
            ...
            <div class="border-start border-end border-light">
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-md-12 position-relative">
                        <div class="position-absolute top-0 start-75 ms-3 translate-start">
                            <button class="btn btn-sm btn-light rounded-0 px-5 py-2 mt-md-5 pFont" onclick="window.location.href='<?= $base ?>pages/contact-us.php';">
                                Contact Us
                            </button>
                        </div>
                        <img
                ...
                <div class="row g-3 justify-content-between px-3 py-5 pFont small d-none">
                    <div class="col-md-12">
                ...
                <div class="row g-3 p-3 pFont small">

                    <!-- Company -->
                    <div class="col-6 col-md-2">
                        <h2 class="text-white mb-3 fw-semibold fs-5">Company</h2>
                    ...
                    <div class="col-6 col-md-3">
                        <h2 class="text-white mb-3 fw-semibold fs-5">Services</h2>

                        <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                                <a href="<?= $base ?>pages/services.php" class="text-decoration-none text-white">
                                    For an Individuals
                                </a>
                            </li>
                    ...
                    <!-- Download App -->
                    <div class="col-6 col-md-3">
                        <h2 class="text-white mb-3 fw-semibold fs-5">Download App</h2>

                        <ul class="list-unstyled mb-0">

                            <li class="mb-2">
                                <a href="https://play.google.com/store/apps/details?id=com.equitypandit.live"
                                    target="_blank"
                            ...
                            <li class="mb-2">
                                <a href="https://apps.apple.com/in/app/equitypandit-lite/id6444849307"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    class="text-decoration-none text-white">
                                    iOS
                    ...
                    <div class="col-6 col-md-4">
                        <h2 class="text-white mb-3 fw-semibold fs-5">Legal &amp; Privacy</h2>

                        <ul class="list-unstyled mb-0">

                            <li class="mb-2">
                                <a href="<?= $base ?>pages/terms-conditions.php" class="text-decoration-none text-white">
                                    Terms and Conditions
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?= $base ?>documents/EP_Grievance_Redressal_Escalation_Matrix.pdf"
                                    target="_blank"
                                    class="text-decoration-none text-white">
                            ...
                            <li class="mb-2">
                                <a href="<?= $base ?>pages/privacy-policy.php" class="text-decoration-none text-white">
                                    Privacy Policy
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?= $base ?>pages/disclosures.php" class="text-decoration-none text-white">
                                    Disclosure
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?= $base ?>documents/INVESTOR_CHARTER_EP.pdf"
                                    target="_blank"
                                    class="text-decoration-none text-white">
                                    Investor Charter
                                </a>
                            ...
                            <li class="mb-2">
                                <a href="<?= $base ?>pages/grievance-mechanism.php" class="text-decoration-none text-white">
                                    Investor Grievance
                                </a>
                            </li>

                            <li>
                                <a href="<?= $base ?>pages/compliance-audit.php" class="text-decoration-none text-white">
                                    Compliance Audit
                                </a>
                            </li>
