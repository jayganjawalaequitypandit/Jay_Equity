                                            ...
                                            <div class="dropdown-menu dropdown-menu-end p-3 shadow border-0"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="d-flex gap-2 mt-2">
                                                        <button id="lightThemeBtn" class="btn btn-outline-primary flex-fill">
                                                            <i class="fa fa-sun"></i><br>
                                                            <small>Light</small>
                                                        </button>

                                                        <button id="darkThemeBtn" class="btn btn-outline-primary flex-fill">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex gap-2 mt-2">
                                                        <button id="normalFontBtn" class="btn btn-outline-primary flex-fill">
                                                            A<br><small>Normal</small>
                                                        </button>

                                                        <button id="increaseFontBtn" class="btn btn-outline-primary flex-fill">
                                                            A+<br><small>Increase</small>
                                                        </button>

                                                        <button id="decreaseFontBtn" class="btn btn-outline-primary flex-fill">
